...
var length = +prompt("Какое расстояние в км между двумя городами?"),
    time = +prompt("За сколько часов хочешь добраться?");
var speed = Math.floor(length / time) + " km/hour";
console.log(speed);
/*6)   Реализуйте конвертор валют. Пользователь вводит доллары, программа переводит в евро. Курс валюты храните в константе.*/

var usd_eur = 82,
    USD = +prompt("Введи цену в долларах.");
var EUR = USD * usd_eur / 100;
console.log(EUR);
...
var main_file = 820,
    flesh_drive = +prompt("Какой объем твоей флешки?");
...
var account = +prompt("Какая сумма в кошельке?"),
    prise_choco = +prompt("Цена шоколадки?");
var quantity_choco = Math.floor(account / prise_choco),
    change = account - prise_choco * quantity_choco;
