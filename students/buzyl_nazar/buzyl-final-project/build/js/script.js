...
/* harmony import */ var _fetchCocktail__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./fetchCocktail */ "./src/js/fetchCocktail.js");
/* harmony import */ var _fetchCocktailById__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./fetchCocktailById */ "./src/js/fetchCocktailById.js");
/* harmony import */ var _coPopDrinksHtml__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./coPopDrinksHtml */ "./src/js/coPopDrinksHtml.js");
/* harmony import */ var _coCatalogHtml__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./coCatalogHtml */ "./src/js/coCatalogHtml.js");
...
var ftCocktail = new _fetchCocktail__WEBPACK_IMPORTED_MODULE_4__["default"]();
var ftCocktailById = new _fetchCocktailById__WEBPACK_IMPORTED_MODULE_5__["default"]();
var htmlPopCocktail = new _coPopDrinksHtml__WEBPACK_IMPORTED_MODULE_6__["default"]();
var htmlCoCatalog = new _coCatalogHtml__WEBPACK_IMPORTED_MODULE_7__["default"]();
...
var defaultIdRecipe = 'coRecipeContainer'; // Search

searchCocktail.addEventListener("keyup", function (e) {
  if (e.keyCode === 13) getInfoCocktail();
});
btnCocktail.addEventListener("click", getInfoCocktail); // Fetch Cocktail
...
function addEventBtnRecipe(data, openBtnId, containerId, closeBtnId) {
  ...
  data.drinks.forEach(function (elem) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_3___default()("#".concat(openBtnId).concat(elem.idDrink)).click(function () {
      jquery__WEBPACK_IMPORTED_MODULE_3___default()("#".concat(containerId).concat(elem.idDrink)).addClass('visible-recipe');
      jquery__WEBPACK_IMPORTED_MODULE_3___default()(document.body).addClass('recipe-open');
      console.log('open');
    });
    jquery__WEBPACK_IMPORTED_MODULE_3___default()("#".concat(closeBtnId).concat(elem.idDrink)).click(function () {
      jquery__WEBPACK_IMPORTED_MODULE_3___default()("#".concat(containerId).concat(elem.idDrink)).removeClass('visible-recipe');
      jquery__WEBPACK_IMPORTED_MODULE_3___default()(document.body).removeClass('recipe-open');
      console.log('close');
    });
  }); // console.log(data);
} // ||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
