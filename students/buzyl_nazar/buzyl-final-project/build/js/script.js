  ...
  _createClass(CoDayDrinks, [{
    ...
    value: function getCocktailData(index) {
      ...
      ftCocktailRan.getCurrent().then(function (data) {
        ...
        _this2.saveToCookie(data, index);
...
/* harmony import */ var _fetchCocktail__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./fetchCocktail */ "./src/js/fetchCocktail.js");
/* harmony import */ var _fetchCocktailById__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./fetchCocktailById */ "./src/js/fetchCocktailById.js");
/* harmony import */ var _coPopDrinksHtml__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./coPopDrinksHtml */ "./src/js/coPopDrinksHtml.js");
/* harmony import */ var _coCatalogHtml__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./coCatalogHtml */ "./src/js/coCatalogHtml.js");
/* harmony import */ var _coDayDrink__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./coDayDrink */ "./src/js/coDayDrink.js");
...
if (cocktail !== null) {
  ...
  var addEventBtnRecipe = function addEventBtnRecipe(data, openBtnId, containerId, closeBtnId) {
    data.drinks.forEach(function (elem) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_8___default()("#".concat(openBtnId).concat(elem.idDrink)).click(function () {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_8___default()(document.body).addClass('recipe-open');
        console.log('open');
      });
      jquery__WEBPACK_IMPORTED_MODULE_8___default()("#".concat(closeBtnId).concat(elem.idDrink)).click(function () {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_8___default()(document.body).removeClass('recipe-open');
        console.log('close');
      });
    });
  };
  ...
  // Cocktail
  // ||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
  var ftCocktail = new _fetchCocktail__WEBPACK_IMPORTED_MODULE_9__["default"]();
  var ftCocktailById = new _fetchCocktailById__WEBPACK_IMPORTED_MODULE_10__["default"](); // const ftCocktailRan = new FetchCocktailRan();

  var htmlPopCocktail = new _coPopDrinksHtml__WEBPACK_IMPORTED_MODULE_11__["default"]();
  var htmlCoCatalog = new _coCatalogHtml__WEBPACK_IMPORTED_MODULE_12__["default"]();
  var coDayDrinks = new _coDayDrink__WEBPACK_IMPORTED_MODULE_13__["default"]();
  ...
  coDayDrinks.getFromCookie(qtyDayDrinks); // Search
