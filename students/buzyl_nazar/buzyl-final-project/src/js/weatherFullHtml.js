class WeatherFullHtml {
    ...
    populateUI(data) {
        let sunsetTime = data.sys.sunrise;
        let hoursSunset = sunsetTime.getHours();
        let minutesSunset = "0" + sunsetTime.getMinutes();

        this.sunset = hoursSunset + ':' + minutesSunset.substr(-2);
        // data.sys.sunrise
                    ...
                    <div>
                        ...
                        <div class="we-info-full__sun-rise-set-block">
                            <div class="we-info-full__sunrise">
                                ...
                                <p class="we-info-full__sun-text">${this.sunrise}</p>
                            </div>
                            <div class="we-info-full__sunset">
                                ...
                                <p class="we-info-full__sun-text">${this.sunset}
                                </p>
                            </div>
                        </div>
                    </div>
