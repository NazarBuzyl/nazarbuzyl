...
getCreateList(playList); // 2. Создать HTML - страницу с кнопкой "Открыть" и модальным окном.На модальном окне должен быть текст и кнопка
...
var circleList = [document.getElementsByClassName('red'), document.getElementsByClassName('yellow'), document.getElementsByClassName('green')];
var count = 0;
var countLight = 0;
