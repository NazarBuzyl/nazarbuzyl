  ...
  return (
    <div className="App">
      ...
      <div className='profile'>
        ...
        <p className='profile__text'>Ich heiße {profile.name}. Ich bin {profile.age} Jahre alt. Ich bin {profile.country} gekommen. Ich bin am {profile.birthday}.</p>
      </div>
        ...
        {Object.keys(socialMedia).map(socialMediaId => (
          <div className="social-media__item">
              <a href={socialMedia[socialMediaId]} className="social-media__link">
                <img className='social-media__img' src={'./icons8-'+socialMediaId+'.gif'} alt={socialMediaId} />
              </a>
          </div>
        ))}
      </div>
